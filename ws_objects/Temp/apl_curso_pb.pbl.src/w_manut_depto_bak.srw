$PBExportHeader$w_manut_depto_bak.srw
$PBExportComments$Manutenção de departamento (backup)
forward
global type w_manut_depto_bak from window
end type
type cb_exportar from commandbutton within w_manut_depto_bak
end type
type cb_inserir from commandbutton within w_manut_depto_bak
end type
type cb_excluir from commandbutton within w_manut_depto_bak
end type
type cb_adicionar from commandbutton within w_manut_depto_bak
end type
type cb_gravar from commandbutton within w_manut_depto_bak
end type
type cb_recuperar from commandbutton within w_manut_depto_bak
end type
type dw_manut_depto from datawindow within w_manut_depto_bak
end type
end forward
...
global w_manut_depto_bak w_manut_depto_bak
...
for i = 1 to vli_NumLinhas
	// valida código
	vli_CodCargo = dw_Manut_Depto.getItemNumber (i, 'cod_depto')
	...
	// valida descrição
	vls_DescCargo = dw_Manut_Depto.getItemString (i, 'desc_depto')
...
long vll_CodDeptoLinha											// código do cargo da linha que está em análise
string vls_ExpressaoBusca										// expressão de busca


// inicialização
vlb_Ok = true
vll_CodDeptoLinha = dw_Manut_Depto.getItemNumber (ai_NumLinha, 'cod_depto')
